...
# --- KONFIGURACJA MODELU ---
# RoBERTa - potężny model ogólny
NAZWA_MODELU_HUGGINGFACE = "roberta-base"
NAZWA_NASZA = "RoBERTa"
...
def main():
    print(f"--- TRENING MODELU: {NAZWA_NASZA} (Model Robust) ---")
    ...
    # 3. Tokenizer (Specyficzny dla RoBERTa)
    ...
    trener = Trainer(
        ...
        args=TrainingArguments(
            output_dir=f'../models/temp/{NAZWA_NASZA}',  # Folder temp
            num_train_epochs=3,
